Panduan untuk menyelesaikan Studi S2 di jurusan Informatika ITS
========================================================
...
* M. Mahaputra Hidayat (dikenal sebagai `MH` atau `Jon`, baca: `Em Ha`, saingan utama `MT`, sang motivator)
...
* Jumlah SKS yang harus anda ambil hingga lulus adalah 36, dengan rincian :
   - 12 SKS mata kuliah semester 1.
   - 18 SKS mata kuliah wajib (sesuai konsentrasi anda, e.g: KCV, NCC, atau RPL)
   - 6 SKS mata kuliah bebas (boleh sesuai atau tidak sesuai dengan konsentrasi anda, __WARNING:__ Rekayasa Pengetahuan masuk di RPL, bukan KCV)
   - 6 SKS tesis
...
=========================
* Setelah tesis anda hampir selesai, anda harus melakukan seminar pra tesis secara mandiri yang dihadiri oleh teman-teman anda sendiri (minimal 3 orang). Sebelumnya, anda harus mendapatkan 1 form dari sekretariat pascasarjana informatika (Ibu Rini Fernando) dan daftar hadir.
